...
<html lang="en">
    <head>
        ...
        <title>Fashioneer - Accessories</title>
        <meta charset="utf-8">
    ...
    <body>
        ...
        <div class="mini-nav">
            <div class="nav-container">
                <a href="Men.php" class="nav-item">Men</a>
                <a href="Women.php" class="nav-item">Women</a>
                <a href="Accessories.php" class="nav-item active">Accessories</a>
                <a href="Cart.php" class="cart-button">Cart (<?php echo isset($_SESSION['cart']) ? count($_SESSION['cart']) : 0; ?>)</a>
            </div>
        </div>
        ...
        <div class="products-grid">
            ...
            if (isset($_POST['add_to_cart'])) {
                ...
                if ($product && $product['stock'] > 0) {
                    ...
                    $_SESSION['previous_page'] = 'Accessories.php';
